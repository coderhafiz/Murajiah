  ...
  return (
    <div className="min-h-dvh flex flex-col bg-background text-foreground font-sans selection:bg-primary/20">
      ...
      <main className="flex-1">
        {/* HERO SECTION */}
        <section className="relative pt-4 pb-16 sm:pt-16 sm:pb-24 md:pt-32 md:pb-48 overflow-hidden">
          ...
          <div className="container px-4 md:px-6 mx-auto grid sm:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Text Content */}
            <div className="text-center sm:text-left space-y-4 md:space-y-8 order-2 sm:order-1 z-10 relative">
