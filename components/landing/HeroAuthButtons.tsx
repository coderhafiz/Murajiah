  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 md:gap-4 pt-2 md:pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
      <Link href="/join">
        <Button
          size="lg"
          className="h-12 md:h-14 px-8 text-lg font-bold rounded-full shadow-xl hover:scale-105 transition-transform bg-linear-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white border-0 shadow-orange-500/20"
        >
